  ...
  return (
    <footer className="border-t border-border/60 bg-muted/30">
      <div className="container mx-auto flex max-w-6xl flex-col gap-4 px-4 py-8 text-sm text-muted-foreground">
        ...
        <div className="flex flex-col items-center gap-1 border-t border-border/60 pt-4 text-center text-xs sm:flex-row sm:items-center sm:justify-between sm:text-left">
